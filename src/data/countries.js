// [TÉLÉPHONE] Liste complète des pays (section 12) : nom en français, code ISO 3166-1
// alpha-2 (pour dériver le drapeau, voir utils/countryFlag.js) et indicatif
// téléphonique international. Triée par nom pour la recherche/l'affichage.
export const countries = [
  ...
  { name: 'Brunéi Darussalam', iso2: 'BN', dialCode: '+673' },
  ...
  { name: 'Îles Marshall', iso2: 'MH', dialCode: '+692' },
  ...
  { name: 'République du Congo', iso2: 'CG', dialCode: '+242' },
  { name: 'République tchèque (Tchéquie)', iso2: 'CZ', dialCode: '+420' },
  ...
  { name: 'Sainte-Lucie', iso2: 'LC', dialCode: '+1758' },
  { name: 'Salomon (Îles)', iso2: 'SB', dialCode: '+677' },
  { name: 'Salvador', iso2: 'SV', dialCode: '+503' },
  { name: 'Samoa', iso2: 'WS', dialCode: '+685' },
  { name: 'São Tomé-et-Príncipe', iso2: 'ST', dialCode: '+239' },
